...
預設的 [Google Analytics](https://developers.google.com/analytics/devguides/collection/analyticsjs/) 外掛程式。這是一個用於測量使用者如何與您的網站互動的 JavaScript 函式庫，**僅在正式環境建置中運作**。如果您使用 Google Analytics 4，可能需要考慮改用 [plugin-google-gtag](./plugin-google-gtag.mdx)。
