...
Docusaurus 提供一系列腳本協助您生成、運行和部署網站。
...
請注意，部分功能（例如錨點連結）在開發環境中無法運作。這些功能在正式環境會正常運作。

:::

:::info[網路開發環境]

當從遠端伺服器或虛擬機（如 GitHub Codespaces）轉發 3000 端口時，可透過 `0.0.0.0` 參數讓開發伺服器監聽本地 IP 位址。
...
此交互式 CLI 將引導您完成完整的[元件替換流程](./swizzling.mdx)。
