...
若您使用 `@docusaurus/preset-classic` 預設配置，則無需將此插件作為依賴項安裝。
...
Markdown 頁面可使用以下 Markdown [前置資料](../../guides/markdown-features/markdown-features-intro.mdx#front-matter)元資料欄位，需以 `---` 行包圍。
