...
舉例來說，如果你在 `docs/folder/doc1.md` 中，並且想要引用 `docs/folder/doc2.md`、`docs/folder/subfolder/doc3.md` 和 `docs/otherFolder/doc4.md`：
...
絕對檔案路徑也可以相對於網站目錄。但要注意，以 `/docs/` 或 `/blog/` 開頭的連結 **不可移植**，因為如果你創建新的文件版本或進行本地化時，需要手動更新這些連結。
...
- 連結在 GitHub 介面和許多 Markdown 編輯器中仍然有效
- 你可以自訂檔案的 slug 而無需更新所有連結
- 移動檔案時，你的編輯器可能會追蹤這些變更，並且某些編輯器會自動更新檔案連結
