...
Docusaurus 提供一組腳本協助您生成、運行和部署網站。
...
請注意，部分功能（例如錨點連結）在開發模式下無法運作。這些功能在正式環境中會正常運作。

:::

:::info[網路開發模式]

當從遠端伺服器或虛擬機（如 GitHub Codespaces）轉發 3000 端口時，可讓開發伺服器監聽本地 IP 位址：
