...
這些檔案將由 [`write-translations` CLI](../../cli.mdx#docusaurus-write-translations-sitedir) 寫入插件的 i18n 子資料夾，並會在呼叫 [`translateContent()`](#translateContent) 和 [`translateThemeConfig()`](#translateThemeConfig) 之前，根據當前語言環境讀取。
