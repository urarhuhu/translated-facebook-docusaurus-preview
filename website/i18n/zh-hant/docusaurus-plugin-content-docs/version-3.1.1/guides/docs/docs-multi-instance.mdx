...
此功能僅對[版本化文檔](./versioning.mdx)有用。建議在閱讀本頁前先熟悉文檔版本化功能。若您只需要[多側邊欄](./sidebar/multiple-sidebars.mdx)，在單一插件內即可實現。
...
當有人編輯 iOS 文檔時，重新構建包括未變更的 Android 文檔在內的所有內容，真的有必要嗎？

:::

### 版本化與非版本化文檔 {#versioned-and-unversioned-doc}

有時您希望部分文檔進行版本控制，而其他文檔保持「全局性」，對其進行版本化顯得無意義。
...
每個插件實例將擁有獨立的 CLI 命令來標記新版本。執行以下命令即可查看：
