...
以下將逐步說明如何使用 Git 將新初始化的英文 Docusaurus 網站翻譯成法文，假設您已遵循[國際化教學](./i18n-tutorial.mdx)。
...
保持翻譯檔案與原始檔案**同步**可能**具有挑戰性**，特別是對於 Markdown 文件。

### Markdown 翻譯 {#markdown-translations}

當未翻譯的 Markdown 文件被編輯時，**您有責任維護相應的翻譯檔案**，我們目前沒有好的方法來協助您完成此工作。
...
您的翻譯存放在 Git 中，可以使用文檔和部落格插件的 `editLocalizedFiles: true` 選項。
